...
add_filter( 'bdpwr_code_email_text' , function( $text , $email , $code , $expiry ) {
    ...
    $text = "Password reset has been requested for the following email :  " . $email . ". \n will expire at " . bdpwr_get_formatted_date( $expiry ) . "." . "<br/>" . 'Please click on the following link to reset your password. ' . "<br/>" . "<a>" ."http://localhost:3000/newpassword/?email="  . $email . '&code=' . $code . '</a>';
    $otherText = 'test';
